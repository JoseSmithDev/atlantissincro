...
export default function Footer() {
  return (
    <footer className="relative bg-atlantis-blue text-white">
      {/* Wave top decoration - transitions from white (NewsSection) to blue */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-20 md:pt-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-gray-300 text-sm">
              ...
              <li>
                <Link href="/competiciones" className="hover:text-atlantis-red-light transition-colors duration-300">
                  Competiciones
                </Link>
              </li>
              <li>
                <Link href="/contacto" className="hover:text-atlantis-red-light transition-colors duration-300">
                  Contacto
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-gray-400 text-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
            <Link href="/legal/aviso-legal" className="hover:text-white transition-colors duration-300">Aviso Legal</Link>
            <span className="text-white/20">·</span>
            <Link href="/legal/privacidad" className="hover:text-white transition-colors duration-300">Privacidad</Link>
            <span className="text-white/20">·</span>
            <Link href="/legal/cookies" className="hover:text-white transition-colors duration-300">Cookies</Link>
